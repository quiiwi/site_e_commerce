...
// définir le chemin absolu du site (comme dans wordpress)
define('RACINE_SITE', '/PHP/07-site/'); //cette constante servira à créer les chemins absolus utilisés dans haut.inc.php car ce fichier sera inclus dans des scripts qui se situent dans des dossiers différents du site. On ne peut donc pas faire de chemin relatif dans ce fichier.
